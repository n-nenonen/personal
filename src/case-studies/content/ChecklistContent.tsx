const imgPicture = "https://www.figma.com/api/mcp/asset/dc5d92d2-0f0b-42a6-887c-e00609b6952b";
const imgPicture1 = "https://www.figma.com/api/mcp/asset/114d9438-a24e-49f4-b7d3-5e7e0c62eaf0";
const imgImage10 = "https://www.figma.com/api/mcp/asset/81e2aa0b-9bcf-470f-bd65-23f1698adbe5";
const imgImage11 = "https://www.figma.com/api/mcp/asset/21ac302e-e7c1-4277-8b12-b9597f4a3435";
const imgPicture2 = "https://www.figma.com/api/mcp/asset/7cc92eff-bc89-4588-9bdf-fbbb13109eaf";
      ...
      <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0 w-full">
        ...
        <div className="[word-break:break-word] font-bold leading-[0] not-italic relative shrink-0 text-[14px] text-[color:var(--labels-secondary)] text-center tracking-[1.54px] uppercase w-full">
          <p className="mb-0">
            ...
            <span className="[word-break:break-word] font-normal leading-[normal] not-italic">International house helsinki</span>
          </p>
          <p className="mb-0 text-[rgba(60,60,67,0.6)]">
            <span className="leading-[normal]">{`Role: `}</span>
            <span className="[word-break:break-word] font-normal leading-[normal] not-italic">Service Designer, ui designer</span>
          </p>
          <p>
        ...
        <p className="[word-break:break-word] font-normal leading-[0] not-italic relative shrink-0 text-[20px] text-[color:var(--gray-600)] text-center w-full whitespace-pre-wrap">
          <span className="leading-[28px]">{`International House Helsinki (IHH) provides a wide range of official and advisory services for immigrants and businesses. One of the key challenges that gave life to this project is that customers often struggle to understand the overall service offering and related processes. `}</span>
          <span className="font-bold leading-[28px]">{` `}</span>
          <span className="leading-[28px]">I participated and contributed</span>
          <span className="leading-[28px]">{` `}</span>
          <span className="leading-[28px]">to each phase in this project, created all the UI deliverables</span>
          <span className="font-bold leading-[28px]">{` `}</span>
        </p>
        <div className="content-stretch flex flex-col items-center relative shrink-0 w-full">
          <div className="content-center flex flex-wrap gap-[8px] items-center justify-center overflow-clip relative shrink-0 w-full max-w-[582px]">
      ...
      <div className="bg-[var(--gray-default)] content-stretch flex flex-col lg:flex-row items-start overflow-clip relative rounded-[12px] shadow-[0px_4px_3px_0px_rgba(0,0,0,0.07),0px_2px_2px_0px_rgba(0,0,0,0.06)] shrink-0 w-full max-w-[1152px]">
        ...
        <div className="content-stretch flex flex-[1_0_0] flex-col items-center min-w-px overflow-clip p-6 md:p-[48px] relative rounded-bl-[12px] rounded-tl-[12px] self-stretch">
          <div className="[word-break:break-word] font-normal leading-[0] not-italic relative shrink-0 text-[0px] text-[color:var(--gray-600)] w-full whitespace-pre-wrap">
            ...
            <p className="leading-[24px] mb-0 text-[16px]">We understood that the existing situation likely required these customers to navigate various website sections or external resources. The goal was to centralise and simplify this information delivery-- a checklist, a one-stop method with step-by-step instructions for IHH's customers.</p>
            <p className="leading-[24px] mb-0 text-[16px]">​</p>
            <p className="mb-0 text-[16px]">
              ...
              <span className="leading-[24px]">{` International newcomers, entrepreneurs, and employers hiring international talent.`}</span>
            </p>
            <p className="leading-[24px] mb-0 text-[16px]">​</p>
            <p className="text-[16px]">
              <span className="[word-break:break-word] font-bold leading-[24px] not-italic">{`Problem worth solving:  `}</span>
              <span className="leading-[24px]">Make finding information about immigration to Finland simpler for users</span>
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[var(--gray-default)] content-stretch flex flex-col lg:flex-row items-start overflow-clip relative rounded-[12px] shadow-[0px_4px_3px_0px_rgba(0,0,0,0.07),0px_2px_2px_0px_rgba(0,0,0,0.06)] shrink-0 w-full max-w-[1152px]">
        <div className="content-stretch flex flex-[1_0_0] flex-col items-center min-w-px overflow-clip p-6 md:p-[48px] relative rounded-bl-[12px] rounded-tl-[12px] self-stretch">
          <div className="[word-break:break-word] font-normal leading-[0] not-italic relative shrink-0 text-[16px] text-[color:var(--gray-600)] w-full whitespace-pre-wrap">
            ...
            <p className="leading-[24px] mb-0">{`For the Startup Checklist, our exploration focused on essential steps for establishing and growing a business, including legal structures, funding, and international hiring. `}</p>
            <p className="leading-[24px] mb-0">​</p>
        ...
        <div className="bg-[var(--gray-50)] border-[var(--gray-100)] border-l border-solid content-stretch flex flex-[1_0_0] items-center justify-center min-w-px overflow-clip p-6 md:p-[48px] relative rounded-br-[12px] rounded-tr-[12px] self-stretch">
          <div className="flex-[1_0_0] h-[240px] sm:h-[320px] md:h-[384px] min-w-px overflow-clip relative rounded-[12px] shadow-[0px_4px_3px_0px_rgba(0,0,0,0.1),0px_10px_8px_0px_rgba(0,0,0,0.04)]">
            ...
            <div className="absolute h-[410px] left-0 top-0 w-[777px]">
      ...
      <div className="bg-[var(--gray-default)] content-stretch flex flex-col lg:flex-row items-start overflow-clip relative rounded-[12px] shadow-[0px_4px_3px_0px_rgba(0,0,0,0.07),0px_2px_2px_0px_rgba(0,0,0,0.06)] shrink-0 w-full max-w-[1152px]">
        ...
        <div className="content-stretch flex flex-[1_0_0] flex-col items-center min-w-px overflow-clip p-6 md:p-[48px] relative rounded-bl-[12px] rounded-tl-[12px] self-stretch">
          <div className="[word-break:break-word] font-normal leading-[0] not-italic relative shrink-0 text-[16px] text-[color:var(--gray-600)] w-full whitespace-pre-wrap">
            ...
            <p className="leading-[24px] mb-0">​</p>
            <p className="leading-[24px]">{`We conducted a thorough validation phase to ensure the checklists' effectiveness and usability. This involved iteratively testing with representative users from both newcomer and startup communities through usability testing sessions. We also gathered feedback from IHH staff. The testing and feedback process allowed me to make necessary revisions and improvements before the deadline, ensuring the checklists were user friendly and achieved our project goals.`}</p>
          </div>
        </div>
      </div>
      <p className="[word-break:break-word] font-[family-name:var(--font-display)] font-normal leading-[var(--headline-line-height)] min-w-full relative shrink-0 text-[color:var(--gray-600)] text-[length:var(--headline-size)] text-center tracking-[var(--display-tracking)] w-full">
      ...
      <div className="bg-[var(--gray-default)] content-stretch flex flex-col lg:flex-row items-start overflow-clip relative rounded-[12px] shadow-[0px_4px_3px_0px_rgba(0,0,0,0.07),0px_2px_2px_0px_rgba(0,0,0,0.06)] shrink-0 w-full max-w-[1152px]">
        <div className="content-stretch flex flex-[1_0_0] flex-col items-center min-w-px overflow-clip p-6 md:p-[48px] relative rounded-bl-[12px] rounded-tl-[12px] self-stretch">
          <div className="[word-break:break-word] font-normal leading-[0] not-italic relative shrink-0 text-[16px] text-[color:var(--gray-600)] w-full whitespace-pre-wrap">
            ...
            <p className="leading-[24px] mb-0">​</p>
            <p className="leading-[24px] mb-0">{`For IHH, the checklists will lead to to more efficient service delivery, a useful tool to use and improved customer preparedness. `}</p>
            <p className="leading-[24px] mb-0">​</p>
            <p className="leading-[24px] mb-0">After the release of the checklist there has been an 23% increase in page visits in the Support section of the site.</p>
            <p className="leading-[24px] mb-0">​</p>
