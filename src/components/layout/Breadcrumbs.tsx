...
export function Breadcrumbs({ currentLabel }: BreadcrumbsProps) {
  return (
    <nav
      ...
      className="bg-[var(--breadcrumb-bg)] content-stretch flex h-[48px] items-center justify-center overflow-clip px-[72px] py-[16px] relative shrink-0 w-full"
    >
      <div className="content-stretch flex flex-[1_0_0] items-center min-w-px max-w-[1440px] mx-auto relative w-full">
        <p className="text-[16px] text-[color:var(--gray-600)]">
          <Link
            to="/"
